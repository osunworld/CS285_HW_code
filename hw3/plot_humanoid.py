...
Usage examples:
  python hw3/plot_humanoid.py
  python hw3/plot_humanoid.py --smooth 5
  python hw3/plot_humanoid.py --hw3_data /path/to/hw3/data --hw2_data /path/to/hw2/data
"""
...
def main() -> None:
    ...
    plt.plot(x2, y2s, color="#1f77b4", linewidth=2.5, label=f"HW2 ({hw2_run.name})")
    plt.plot(x3, y3s, color="#d62728", linewidth=2.5, label=f"HW3 SAC ({hw3_run.name})")

    plt.title("Humanoid-v4: SAC basic vs clipped (Eval Return)")
